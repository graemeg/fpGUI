...
program find_compilers_freebsd ;
...
const
 ...
 fpc_incl = '-Fi../';
 fpc_outd = '-FU_debug';
 fpc_conf = '-Mdelphi -Tfreebsd -Sg -Se3 -XX -Xs -B -v0i';
    ...
    begin
     if FirstKey('skip' ,value ) then
      ...
      begin
       ...
       if cmp_str(target ) = cmp_str('freebsd' ) then
...
BEGIN
 ...
 writeln('* properly all the AggPas demos on your FreeBSD system.     *' );
 writeln('*                                                           *' );
