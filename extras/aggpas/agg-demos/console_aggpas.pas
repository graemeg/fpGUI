{ Sample program using AggPas and the more user friendly Agg2D API }
...
const
  ...
  RGBA_Width = 4;
  LineCount = 30;
  FontFilePath = '/usr/share/fonts/truetype/ttf-dejavu/DejaVuSans.ttf';
...
procedure TPainter.DrawText(aImage: TFPMemoryImage);
var
