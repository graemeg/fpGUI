...
procedure XMLDefaultCurrent; cdecl; external EXPATLIB name 'XML_DefaultCurrent';
function  XML_ErrorString: PXMLLChar; cdecl; external EXPATLIB name 'XML_ErrorString';
function  XMLExpatVersion: PXMLLChar; cdecl; external EXPATLIB name 'XML_ExpatVersion';
function  XMLExpatVersionInfo: TXMLExpatVersion; cdecl; external EXPATLIB name 'XML_ExpatVersionInfo';
function  XMLExternalEntityParserCreate: TXMLParser; cdecl; external EXPATLIB name 'XML_ExternalEntityParserCreate';
function  XMLGetBase: PXMLChar; cdecl; external EXPATLIB name 'XML_GetBase';
function  XMLGetBuffer: Pointer; cdecl; external EXPATLIB name 'XML_GetBuffer';
function  XMLGetCurrentByteCount: Integer; cdecl; external EXPATLIB name 'XML_GetCurrentByteCount';
function  XMLGetCurrentByteIndex: Longint; cdecl; external EXPATLIB name 'XML_GetCurrentByteIndex';
function  XMLGetCurrentColumnNumber: Integer; cdecl; external EXPATLIB name 'XML_GetCurrentColumnNumber';
function  XML_GetCurrentLineNumber: Integer; cdecl; external EXPATLIB name 'XML_GetCurrentLineNumber';
function  XML_GetErrorCode: TXMLError; cdecl; external EXPATLIB name 'XML_GetErrorCode';
function  XMLGetIdAttributeIndex: Integer; cdecl; external EXPATLIB name 'XML_GetIdAttributeIndex';
function  XMLGetInputContext: PChar; cdecl; external EXPATLIB name 'XML_GetInputContext';
function  XMLGetSpecifiedAttributeCount: Integer; cdecl; external EXPATLIB name 'XML_GetSpecifiedAttributeCount';
function  XML_Parse: XML_Status; cdecl; external EXPATLIB name 'XML_Parse';
function  XMLParseBuffer: Integer; cdecl; external EXPATLIB name 'XML_ParseBuffer';
function  XML_ParserCreate: TXMLParser; cdecl; external EXPATLIB name 'XML_ParserCreate';
function  XMLParserCreateNS: TXMLParser; cdecl; external EXPATLIB name 'XML_ParserCreateNS';
function  XMLParserCreateMM: TXMLParser; cdecl; external EXPATLIB name 'XML_ParserCreate_MM';
procedure XML_ParserFree;
  external EXPATLIB name 'XML_ParserFree';
procedure XMLSetAttlistDeclHandler;
  external EXPATLIB name 'XML_SetAttlistDeclHandler';
function  XMLSetBase: Integer; cdecl; external EXPATLIB name 'XML_SetBase';
procedure XMLSetCdataSectionHandler;
...
procedure XMLSetElementDeclHandler; cdecl; external EXPATLIB name 'XML_SetElementDeclHandler';
procedure XML_SetElementHandler;
  external EXPATLIB name 'XML_SetElementHandler';
function  XMLSetEncoding: Integer; cdecl; external EXPATLIB name 'XML_SetEncoding';
procedure XMLSetEndCdataSectionHandler;
...
function XMLSetParamEntityParsing: Integer; cdecl; external EXPATLIB name 'XML_SetParamEntityParsing';
procedure XMLSetProcessingInstructionHandler;
...
function  XMLGetFeatureList: PXMLFeatureList; cdecl; external EXPATLIB name 'XML_GetFeatureList';
procedure XMLUseForeignDTD;
...
function  XMLMemMalloc: Pointer; cdecl; external EXPATLIB name 'XML_MemMalloc';
function  XMLMemRealloc: Pointer; cdecl; external EXPATLIB name 'XML_MemRealloc';
procedure  XMLMemFree;
