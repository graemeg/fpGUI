...
@set Constants_RST=..\uidesigner\units\%FPCTARGET%\vfd_constants.rst
rstconv -i %Constants_RST% -o ..\uidesigner\languages\uidesigner.po

updatepofiles.exe ..\uidesigner\languages\uidesigner.po


REM generate new include files from the updated .po file.
rem generateincfiles.exe ..
