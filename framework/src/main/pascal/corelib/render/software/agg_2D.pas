{
    ...
    Description:
      This unit implements a Agg2D object for convenience - thus making the
...
{$ENDIF }
 ...
 Agg2D = object
  ...
  // Basic Shapes
   ...
   procedure arc(cx ,cy ,rx ,ry ,start_angle ,end_angle : double );
...
{ ARC }
procedure Agg2D.arc(cx ,cy ,rx ,ry ,start_angle ,end_angle : double );
var
