...
#makeskel --package=GUI --output=xml/gui/gui_editcombo.xml --input='-Fi../src/gui ../src/gui/gui_editcombo.pas'
...
makeskel --package=GUI --output=xml/gui/gui_menu.xml --input='-Fi../src/gui ../src/gui/gui_menu.pas'
