{ In example 3 we aro going to add a stroke to the rendering pipeline. }
program example_pipeline3;
...
begin
  ...
  //-----------------------
  curve.Construct(@path);  // generates the curve line segments for us
