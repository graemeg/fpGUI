{ Here we show added some transformation - rotation and scaling. We add this
  before the curve conversion.}
program example_pipeline5;
...
begin
  ...
  trans.Construct(@path, @matrix);


  curve.Construct(@trans);  // generates the curve line segments
